...
curl -o "/tmp/default.upstream" https://cdn.jsdelivr.net/busymilk/AdguardHomeSetting/refs/heads/master/dns_for_default > /dev/null 2>&1

echo "$DATE: Getting data updates...1.5"
curl -o "/tmp/special.upstream" https://cdn.jsdelivr.net/busymilk/AdguardHomeSetting/refs/heads/master/dns_for_special > /dev/null 2>&1
...
response=$(curl -s https://cdn.jsdelivr.net/busymilk/AdguardHomeSetting/refs/heads/master/dns_only_for_china.conf)
